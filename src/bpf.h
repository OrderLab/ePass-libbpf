...
LIBBPF_API int bpf_prog_load(enum bpf_prog_type prog_type, const char *prog_name,
                             ...
                             struct bpf_prog_load_opts *opts, __u32 enable_epass,
...
LIBBPF_API int bpf_prog_attach(int prog_fd, int attachable_fd, enum bpf_attach_type type,
                               unsigned int flags);
LIBBPF_API int bpf_prog_attach_opts(int prog_fd, int attachable_fd, enum bpf_attach_type type,
...
LIBBPF_API int bpf_prog_query_opts(int target_fd, enum bpf_attach_type type,
